...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    genesis.hashStateRoot = uint256(h256Touint(dev::h256("e965ffd002cd6ad0e2dc402b8044de833e06b23127ea8c3d80aec91410771495"))); // tripi
    genesis.hashUTXORoot = uint256(h256Touint(dev::sha3(dev::rlp("")))); // tripi
    return genesis;
}
...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000fe9a0a868307506a7b"); // tripi
        ...
        vSeeds.emplace_back("tripi3.dynu.net"); // Tripi mainnet
        vSeeds.emplace_back("tripi5.dynu.net"); // Tripi mainnet
        vSeeds.emplace_back("tripi6.dynu.net"); // Tripi mainnet
        vSeeds.emplace_back("tripi7.dynu.net"); // Tripi mainnet
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000042d96d1fbba9348aca"); // tripi
...
public:
    CRegTestParams() {
        ...
        consensus.BIP34Height = 0; // BIP34 has not activated on regtest (far in the future so block v1 are not rejected in tests) // activate for tripi
...
public:
    CUnitTestParams()
    {
        ...
        // TRIPI have 500 blocks of maturity, increased values for regtest in unit tests in order to correspond with it
