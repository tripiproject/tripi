...
////////////////////////////////////////////////////////////// tripi
        ...
        globalState = std::unique_ptr<TripiState>(new TripiState(dev::u256(0), TripiState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::tripiTestNetwork)));
