...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // tripi
        hashUTXORoot.SetNull(); // tripi
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //tripi
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //tripi
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //tripi
    {
