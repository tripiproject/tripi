...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " tripi-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  tripi-tx [options] <hex-tx> [commands]  Update hex-encoded tripi transaction\n" +
            "or:     tripi-tx [options] -create [commands]   Create hex-encoded tripi transaction\n" +
            "\n";
