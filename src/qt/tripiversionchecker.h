#ifndef TRIPIVERSIONCHECKER_H
#define TRIPIVERSIONCHECKER_H

#include <QObject>

#define TRIPI_RELEASES "https://github.com/tripiproject/tripi/releases"
...
class TripiVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit TripiVersionChecker(QObject *parent = 0);
    ~TripiVersionChecker();
